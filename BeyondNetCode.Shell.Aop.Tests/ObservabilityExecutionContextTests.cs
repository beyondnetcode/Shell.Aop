...
using BeyondNetCode.Shell.Aop.Aspects.Logger.Serilog;

namespace BeyondNetCode.Shell.Aop.Tests
{
    [TestClass]
    public class ObservabilityExecutionContextTests
    {
        ...
        {
            var boundedContext = TestStructuredLogger.BoundedContextOf(typeof(BeyondNetCode.Test.Aop.Queries.FakeHandler));

            boundedContext.ShouldBe("Aop");
        }
...
namespace BeyondNetCode.Test.Aop.Queries
{
